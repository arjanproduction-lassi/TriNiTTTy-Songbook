...
export function A4Page({ song, sections, selectedIndex, onSelectBlock, responsive = true, pageRef }: A4PageProps) {
  ...
  return (
    <div ref={pageRef} className="mx-auto bg-white text-zinc-900 shadow-lg ring-1 ring-zinc-300" style={pageStyle}>
                ...
                if (line.type === "pair") {
                  return (
                    <div key={index} className={wrapperClass} {...commonProps}>
                      {!!line.chords && <div className="font-mono text-[9pt] font-semibold leading-[1.05] whitespace-pre text-zinc-800">{line.chords}</div>}
